...
## flexible PCBの実装
うすく曲げることができるPCBをflexible PCBと言います。wraithではキースイッチ部分のPCBはflexible PCBを採用することによって、3次元的なキー配置を実現しています。なおflexible PCBはシルク印刷の精度が通常より悪く、読めないことがあるかもしれないので、綺麗な画像を[flexible PCBのシルク印刷](#flexiblesilk)に乗せてあります。
### ダイオードの実装
ダイオードはそれぞれのflexible PCBにそれぞれ21個あります。これらをすべて実装していきます。ダイオードには向きがあります。[ダイオードの実装](#ダイオードの実装)を参照。
...
<br>LEDのでっぱる厚さよりもflexible PCBは薄いので平らなところに置いてLEDをはんだ付けしようとするとLEDが浮きやすくなります。画像のように適当な隙間を作ってそこではんだ付けするといいかもしれません。
...
<h2 id="flexiblesilk">flexible PCBのシルク印刷</h2>
