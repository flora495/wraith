...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LWIN,  KC_RALT,  XXXXXXX,  LT(1,KC_TAB),LT(2,KC_SPC),LT(3,KC_LNG2),    CTL_T(KC_LNG1),   KC_RCTL , KC_BSPC,  KC_COMM,  KC_DOT,   LT(3,KC_ESC)
    ),
    [1] = LAYOUT(
    ...
    [2] = LAYOUT(
        ...
        XXXXXXX,  XXXXXXX, XXXXXXX,XXXXXXX,KC_SPC,XXXXXXX,                 XXXXXXX,  XXXXXXX, KC_DEL,XXXXXXX,XXXXXXX,XXXXXXX
    ),
    [3] = LAYOUT(
